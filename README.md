...
general idea
----------------
style: rick and mortyish?(svg friendly)
library: react + custom react component library built for handling setting up click and point adventures using svgs.
...
stats - mechanics used to control the flow of the game and create urgency/intensity in the player.\
buffs - optional mechanics that will create an easier game for the player if the are savvy enough to find them.
